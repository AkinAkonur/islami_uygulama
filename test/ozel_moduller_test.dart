...
void main() {
  ...
  testWidgets("Gunluk Gorev sayfasi gorev ve seriyi isler", (tester) async {
    ...
    await tester.ensureVisible(find.text('Günlük Görevler'));
    ...
    await tester.ensureVisible(find.text('Sabah Namazı'));
    ...
    await tester.ensureVisible(find.text('1 Ayet Oku'));
  ...
  testWidgets("Hedef Carki sayfasi ilerlemeyi isler", (tester) async {
    ...
    await tester.ensureVisible(find.text('Hedef Çarkı'));
  ...
  testWidgets("Hedef carkina kullanici hedef ekler ve kaldirir", (tester) async {
    ...
    await tester.ensureVisible(find.text('Ekle'));
    await tester.pump();
  ...
  testWidgets("Tesbih sayfasi zikir ekler ve kaldirir", (tester) async {
    ...
    await tester.ensureVisible(find.text('Hızlı Tesbih').first);
  ...
  testWidgets("Ramazan Modu sayfasi geri sayim ve ozel gunler icerir", (
    ...
    await tester.ensureVisible(find.textContaining('Ramazan Modu').first);
    ...
    await tester.ensureVisible(find.text('Hatim sayfasına git'));
  ...
  testWidgets("Konum ve Widget Rehberi sayfalari acilir", (tester) async {
    ...
    await tester.ensureVisible(find.text('Cami & Konum'));
    ...
    await tester.ensureVisible(find.text('Widget Rehberi'));
