...
const List<OzelSureVerisi> ozelSureler = [
  OzelSureVerisi(
    ...
    sureNo: 36,
    arapca: 'يس \nوالقرآن الحكيم \nإنك لمن المرسلين \nعلى صراط مستقيم \nتنزيل العزيز الرحيم',
    mealTr: 'Yâsîn Suresi. Kur\'an-ı Kerim\'in 36. suresidir; önemli surelerden biridir. Gece okunması tavsiye edilir. Hz. Peygamber (s.a.v.), geceleri Yâsîn okumayı teşvik etmiş ve onu "Kur\'an\'ın kalbi" olarak nitelemiştir.',
  ...
  OzelSureVerisi(
    ...
    mealTr: 'Mülk Suresi. Mülk (hükümranlık) O\'nun elindedir; O her şeye kadirdir. Ölümü ve hayatı yaratmıştır ki, hanginizin daha güzel amel işlediğini denesin. O, mutlak güç sahibidir, çok bağışlayandır. Yedi göğü de O yaratmıştır.',
  ...
  OzelSureVerisi(
    ...
    mealTr: 'İnşirâh Suresi. Senin göğsünü açıp genişletmedik mi? Belini büken ağır yükünü senden indirmedik mi? Senin şanını yüceltmedik mi? Şüphesiz zorlukla beraber bir kolaylık vardır; gerçekten zorlukla beraber bir kolaylık vardır.',
  ...
  OzelSureVerisi(
    ...
    mealTr: 'Kıyâmet Suresi. Kıyâmet gününe yemin ederim. Kendini (kötülükten dolayı) kınayan nefse de yemin ederim. İnsan, kemiklerini bir araya toplayamayacağımızı mı sanıyor? Evet, biz onun parmak uçlarını bile yeniden düzene koyabiliriz.',
  ...
  OzelSureVerisi(
    ...
    mealTr: 'Vâki\'a Suresi. O (Kıyâmet) hadisesi gerçekleştiği zaman. Onun gerçekleşmesini yalanlayacak kimse yoktur. O, (bazılarını) alçaltıcı, (bazılarını) yükselticidir.',
  ...
  OzelSureVerisi(
    ...
    mealTr: 'Duha Suresi. Kuşluk vaktine andolsun. Karanlığıyla çöküp sakinleşen geceye andolsun. Rabbin seni terk etmedi ve sana darılmadı. Elbette ahiret, senin için dünyadan daha hayırlıdır.',
