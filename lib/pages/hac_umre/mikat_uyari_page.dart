        ...
        children: [
                ...
                child: _izliyor
                    ? OutlinedButton.icon(
                        style: OutlinedButton.styleFrom(
                          ...
                          side: const BorderSide(color: Renkler.hata),
          ...
          if (_hata != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Renkler.hata.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: Renkler.hata.withValues(alpha: 0.4),
                ),
              ),
              child: Row(
                children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14),
              border: Border.all(
                color: Renkler.acikAltinSabit.withValues(alpha: 0.3),
              ),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class _UyariKarti extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final renk = ciddi ? Renkler.hata : Renkler.uyari;
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Renkler.kart,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: Renkler.zumrutSabit.withValues(alpha: 0.4)),
      ),
      child: Row(
        children: [
          const UcdIkon(
