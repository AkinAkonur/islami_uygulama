      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              l.t('im.reset'),
              style: const TextStyle(color: Renkler.hata),
            ),
          ),
        ],
      ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Text(
                        '⚠️ ',
                        style: TextStyle(color: Renkler.uyari),
                      ),
                      Expanded(
                        child: Text(
                          h,
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Renkler.acikZumrutSabit.withValues(alpha: 0.15),
              shape: BoxShape.circle,
            ),
            child: Text(
              '$sira',
              style: const TextStyle(
                color: Renkler.acikZumrutSabit,
                fontSize: 11,
                fontWeight: FontWeight.bold,
              ),
            ),
