          ...
          return Card(
            ...
            child: ListTile(
              leading: CircleAvatar(
                backgroundColor: Renkler.altinSabit.withValues(alpha: 0.2),
                child: Text(
                  "${index + 1}",
                  style: TextStyle(color: Renkler.altinSabit),
                ),
              ),
              title: Text(
                '${item[0]}  •  ${item[1]}',
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              color: zekatVar ? Renkler.acikAltinSabit : Colors.white70,
              fontWeight: FontWeight.bold,
              fontSize: 16,
            ),
          ),
        ...
        ValueListenableBuilder<String?>(
          ...
          builder: (context, hata, _) => hata == null
              ...
              : Padding(
                  ...
                  child: Text(
                    hata,
                    style: const TextStyle(color: Renkler.hata, fontSize: 12),
                  ),
                ),
        ),
