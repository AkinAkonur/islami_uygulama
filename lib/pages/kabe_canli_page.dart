  ...
  Future<void> _veriUyarisiniKontrolEt({
    ...
    final onay = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            const UcdIkon(ikon: Icons.wifi_tethering_rounded, renk: Renkler.uyari, boyut: 24),
    ...
    return UcdButon(
      ...
      child: Row(
        children: [
          ...
          if (secili)
            const UcdIkon(ikon: Icons.check_circle_rounded, renk: Renkler.zumrutSabit, boyut: 16),
        ],
      ),
    );
  }
    ...
    return Row(
      children: [
        UcdIkon(
          ...
          renk: _baglantiVar ? Renkler.zumrutSabit : Renkler.hata,
          boyut: 16,
        ),
        const SizedBox(width: 8),
        Expanded(
  ...
  Widget _baglantiYokSata() {
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Renkler.hata.withValues(alpha: 0.9),
