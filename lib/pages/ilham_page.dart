          ...
          child: Column(
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                icon: const UcdIkon(ikon: Icons.notifications_active_outlined, renk: Renkler.uyari, boyut: 18),
                label: const Text(
              ...
              if (mevcut != null) ...[
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(foregroundColor: Renkler.hata),
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            ValueListenableBuilder<IlhamHatirlatma?>(
              ...
              builder: (context, kayit, _) => IconButton(
                ...
                icon: UcdIkon(
                  ...
                  renk: kayit != null ? Renkler.uyari : Colors.white70,
                ),
          ...
          bottom: TabBar(
            indicatorColor: Renkler.uyari,
            labelColor: Renkler.uyari,
...
class _GununAkisiTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<IlhamIcerik>>(
      ...
      builder: (context, snp) {
        if (!snp.hasData) {
          return Center(child: CircularProgressIndicator(color: Renkler.uyari));
        }
        final akis = snp.data!;
        if (akis.isEmpty) {
          return const Center(
        ...
        return ListView(
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  const UcdIkon(ikon: Icons.wb_sunny_rounded, renk: Renkler.uyari, boyut: 18),
                  const SizedBox(width: 8),
                  Text(
...
class _ArsivGunu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ExpansionTile(
        leading: const UcdIkon(ikon: Icons.history, renk: Renkler.uyari, boyut: 20),
        title: Text(
          _tarihYaz,
          style: const TextStyle(
            color: Colors.white,
      ...
      builder: (context, fav, _) {
        ...
        return FutureBuilder<List<IlhamIcerik>>(
          ...
          builder: (context, snp) {
            if (!snp.hasData) {
              return Center(
                child: CircularProgressIndicator(color: Renkler.uyari),
              );
            }
