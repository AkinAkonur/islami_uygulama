              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    _halkaKarti(
                      tur: 'kuran',
                      baslik: AppLocalizations.aktif.t('hc.g.kuran'),
                      hedef: AppLocalizations.aktif.t('hc.t.kuran'),
                      ikon: Icons.menu_book_rounded,
                    ),
                    const SizedBox(height: 16),
                    _halkaKarti(
                      tur: 'zikir',
                      baslik: AppLocalizations.aktif.t('hc.g.zikir'),
                      hedef: AppLocalizations.aktif.t('hc.t.zikir'),
                      ikon: Icons.radio_button_checked_rounded,
                    ),
                    const SizedBox(height: 16),
                    _halkaKarti(
                      tur: 'namaz',
                      baslik: AppLocalizations.aktif.t('hc.g.namaz'),
                      hedef: AppLocalizations.aktif.t('hc.t.namaz'),
                      ikon: Icons.mosque_rounded,
                    ),
                    const SizedBox(height: 16),
                    _halkaKarti(
                      tur: 'dua',
                      baslik: AppLocalizations.aktif.t('hc.g.dua'),
                      hedef: AppLocalizations.aktif.t('hc.t.dua'),
                      ikon: Icons.favorite_outline_rounded,
                    ),
                    const SizedBox(height: 16),
                    _halkaKarti(
                      tur: 'tesbih',
                      baslik: AppLocalizations.aktif.t('hc.g.tesbih'),
                      hedef: AppLocalizations.aktif.t('hc.t.tesbih'),
                      ikon: Icons.filter_vintage_rounded,
                    ),
                    const SizedBox(height: 16),
                    _halkaKarti(
                      tur: 'sadaka',
                      baslik: AppLocalizations.aktif.t('hc.g.sadaka'),
                      hedef: AppLocalizations.aktif.t('hc.t.sadaka'),
