          ...
          children: [
            ...
            if (_dogru)
              Container(
                ...
                decoration: BoxDecoration(
                  color: Renkler.basari.withValues(alpha: 0.15),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  '${l.t('gd.correct')} ${widget.soru.cevap}',
                  style: const TextStyle(
                    color: Renkler.zumrutSabit,
                    fontSize: 13,
                    height: 1.4,
                  ),
                ),
                  ...
                  child: UcdButon(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _secili == i
                              ? (_dogru ? Renkler.zumrutSabit : Renkler.hata)
                              : Colors.transparent,
                        ),
                      ),
                      child: Text(
            ...
            if (!_dogru && _secili != null)
              Padding(
                ...
                child: Text(
                  l.t('gd.wrongHint'),
                  style: const TextStyle(color: Renkler.hata, fontSize: 11),
                ),
              ),
          ],
        ),
