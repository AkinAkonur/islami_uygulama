...
class _GizlilikMerkeziPageState extends State<GizlilikMerkeziPage> {
  ...
  Future<void> _hesabiVeVerileriSil(AppLocalizations l) async {
    ...
    final onay = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        icon: const UcdIkon(ikon: Icons.warning_amber_rounded, renk: Renkler.hata),
        title: Text(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        backgroundColor: Renkler.hata.withValues(alpha: 0.85),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _bolumBasligi(l.t('gm.rights'), Icons.verified_user_rounded, Renkler.acikAltinSabit),
          const SizedBox(height: 2),
          ...
          const SizedBox(height: 12),
          _bolumBasligi(l.t('gm.legal'), Icons.gavel_rounded, Renkler.uyari),
          const SizedBox(height: 2),
          _yasalKart(l),
          const SizedBox(height: 12),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 52,
            decoration: BoxDecoration(
              color: Renkler.zumrutSabit.withValues(alpha: 0.15),
              shape: BoxShape.circle,
            ),
            child: const UcdIkon(ikon: Icons.shield_rounded, renk: Renkler.zumrutSabit, boyut: 28),
          ),
        ...
        children: [
          ...
          if (izin.id == 'izin_konum') ...[
            ...
            Text(
              ...
              style: TextStyle(
                color: _konumAktif ? Renkler.zumrutSabit : Renkler.uyari,
                fontSize: 12,
    ...
    if (izin.id == 'izin_analitik') {
      return ValueListenableBuilder<bool>(
        ...
        builder: (context, kapali, _) => Switch(
          value: kapali,
          activeThumbColor: Renkler.zumrutSabit,
  ...
  Widget _hakKarti(GizlilikKullaniciHakki hak, AppLocalizations l) {
    ...
    final renk = tehlikeli ? Renkler.hata : Renkler.vurgu;
