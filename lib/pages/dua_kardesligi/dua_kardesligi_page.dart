  ...
  Future<void> _sikayetEt(DuaIstegi istek) async {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(backgroundColor: Renkler.hata),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: kaldirildi ? Renkler.hata : Renkler.zemin,
      ),
    );
  }
                ...
                IconButton(
                  ...
                  icon: Icon(
                    ...
                    color: istek.benSikayetEttim
                        ? Renkler.hata.withValues(alpha: 0.5)
                        : Colors.white38,
                  ),
                ),
              ],
