            ...
            builder: (context, fav, _) {
              ...
              return IconButton(
                ...
                icon: UcdIkon(
                  ...
                  renk: secili ? Renkler.hata : Colors.white70,
                ),
            ...
            builder: (context, hatirlatmalar, _) {
              ...
              return IconButton(
                ...
                icon: UcdIkon(
                  ...
                  renk: aktif ? Renkler.uyari : Colors.white70,
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: tamamlandi ? Renkler.zumrutSabit : Renkler.cerceve,
        ),
      ),
      child: Column(
        children: [
            ...
            child: Column(
              children: [
                Text(
                  '$_sayi',
                  style: TextStyle(
                    color: tamamlandi ? Renkler.zumrutSabit : Renkler.vurgu,
                    fontSize: 40,
                    fontWeight: FontWeight.bold,
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation(
                        tamamlandi ? Renkler.zumrutSabit : Renkler.vurgu,
                      ),
                    ),
                  ),
                  const SizedBox(height: 6),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Renkler.acikAltinSabit.withValues(alpha: 0.3)),
      ),
      child: Row(
        ...
        return UcdButon(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: kayit != null
                    ? Renkler.uyari.withValues(alpha: 0.5)
                    : Renkler.cerceve,
              ),
            ),
            child: Row(
              children: [
                UcdIkon(
                  ...
                  renk: kayit != null ? Renkler.uyari : Colors.white38,
                  boyut: 20,
                ),
                const SizedBox(width: 10),
                Expanded(
