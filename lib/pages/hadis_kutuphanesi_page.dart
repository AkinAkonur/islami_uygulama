        ...
        if (_listeHata != null) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Renkler.uyari.withValues(alpha: 0.08),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: Renkler.uyari.withValues(alpha: 0.3)),
            ),
            child: Text(
              _listeHata!,
              style: const TextStyle(color: Renkler.uyari, fontSize: 11),
            ),
          ),
        ],
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            if (hazir)
              const UcdIkon(ikon: Icons.offline_pin_rounded, renk: Renkler.zumrutSabit, boyut: 18)
            else
              IconButton(
      ...
      content: Column(
        ...
        children: [
          ...
          Text(
            _hata ?? _durum,
            style: TextStyle(
              color: _hata != null ? Renkler.uyari : Colors.white70,
              fontSize: 12,
            ),
          ),
          if (_hataDetay != null) ...[
...
Widget _dereceEtiketi(String derece) {
  final renk = switch (derece.toLowerCase()) {
    'sahih' => Renkler.zumrutSabit,
    'hasan' => Renkler.acikAltinSabit,
    'hasan sahih' => Renkler.acikAltinSabit,
    _ => Renkler.uyari,
  };
  return Container(
