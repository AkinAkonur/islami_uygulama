...
class AppLocalizations {
  ...
  String kisaVakitAdi(String ad) {
    final kod = switch (ad) {
      'İmsak' => 'imsak', 'Güneş' => 'gunes', 'Öğle' => 'ogle',
      'İkindi' => 'ikindi', 'Akşam' => 'aksam', 'Yatsı' => 'yatsi',
      _ => null,
    };
    return kod == null ? vakitAdi(ad) : t('v.short.$kod');
  }

  String hesapMetodu(String kod) => ['13', '3', '2', '1', '4', '5'].contains(kod)
      ? t('v.method.$kod') : t('set.methodAuto');
