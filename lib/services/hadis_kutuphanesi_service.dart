...
class HadisKutuphanesiService {
  ...
  static const Map<String, String> _dilEslestirme = {
    ...
    'ar': 'ara',
    'id': 'ind',
    // Depoda Malayca ayrı bir koleksiyon bulunmadığı için Malayca kullanıcıya
    // Endonezce içerik gösterilmez; İngilizce, doğrulanmış yedek dildir.
    // Böylece yanlış dili Malayca diye etiketleme hatası önlenir.
    'ms': 'eng',
    'ur': 'urd',
    'bn': 'ben',
    'fr': 'fra',
